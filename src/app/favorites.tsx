    ...
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      {loading ? (
        ...
        <View className="flex-1 items-center justify-center">
          ...
          <Text className="text-sm mt-4" style={{ color: colors.textDim }}>Failed to load</Text>
        </View>
      ) : movies.length === 0 ? (
        <View className="flex-1 items-center justify-center">
          <Ionicons name="heart-outline" size={48} color={colors.textVeryDim} />
          <Text className="text-sm mt-4" style={{ color: colors.textDim }}>No favorites yet</Text>
        </View>
      ) : (
        <FlatList
          data={movies}
